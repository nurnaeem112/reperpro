    ...
    <div className="pt-48 pb-32 px-6 relative overflow-hidden">
      ...
      <section className="max-w-7xl mx-auto text-center relative mb-32">
        <motion.div 
          ...
          className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-full bg-primary/5 border border-primary/10 backdrop-blur-md mb-8"
        >
      ...
      <section className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-20 items-center mb-32">
        <div className="lg:col-span-7">
          <h2 className="text-4xl md:text-5xl font-bold mb-8 text-on-surface leading-tight">Scaling Impact <br/>Without Burnout.</h2>
        ...
        <div className="lg:col-span-5 relative">
          <div className="aspect-square rounded-5xl overflow-hidden bg-surface-container border border-black/5 shadow-2xl group">
            <img 
          ...
          <div className="absolute -bottom-10 -left-10 p-8 bg-white/60 backdrop-blur-2xl rounded-3xl border border-black/10 shadow-2xl max-w-[280px]">
      ...
      <section className="max-w-7xl mx-auto mb-32">
        <div className="text-center mb-20">
          <h2 className="text-4xl font-bold text-on-surface mb-6">Our Core Values</h2>
      ...
      <section className="max-w-7xl mx-auto">
        <h2 className="text-5xl font-bold text-on-surface mb-20 text-center tracking-tighter">The Minds Behind the Magic.</h2>
...
function StatCard({ value, label, color, highlighted }: any) {
  return (
    <div className={cn(
      ...
      highlighted ? "bg-white border-black/10 shadow-2xl scale-105 z-10" : "bg-surface-container-low border-black/5"
    )}>
      <span className={cn("text-5xl font-black mb-3 tracking-tighter", highlighted ? "text-on-surface" : color)}>{value}</span>
...
function ValueCard({ icon, title, desc }: any) {
  return (
    <div className="group p-10 rounded-4xl bg-surface-container-low transition-all duration-500 hover:bg-surface-container border border-black/5 hover:border-primary/20">
      ...
      <h3 className="text-2xl font-bold text-on-surface mb-4 transition-colors group-hover:text-primary">{title}</h3>
...
function TeamMember({ name, role, img }: any) {
  return (
    <div className="space-y-6 group">
      <div className="aspect-[4/5] rounded-4xl bg-surface-container-highest overflow-hidden grayscale group-hover:grayscale-0 transition-all duration-700 border border-black/5 group-hover:border-primary/30">
