...
export function Footer() {
  return (
    <footer className="bg-surface w-full py-24 px-8 border-t border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-16 md:gap-8 relative z-10">
        ...
        <div className="space-y-8">
          <h4 className="text-white font-bold text-[10px] uppercase tracking-[0.2em]">Product</h4>
        ...
        <div className="space-y-8">
          <h4 className="text-white font-bold text-[10px] uppercase tracking-[0.2em]">Company</h4>
          <ul className="space-y-4">
        ...
        <div className="space-y-8">
          <h4 className="text-white font-bold text-[10px] uppercase tracking-[0.2em]">Legal</h4>
          <ul className="space-y-4">
